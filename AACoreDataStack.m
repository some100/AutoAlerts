...
-(id)init {
    if (self = [super init]) {
        NSURL *url = [NSURL fileURLWithPath:@"/var/jb/Library/PreferenceBundles/AutoAlertsPreferences.bundle/AutoAlerts.momd"];
		
		NSManagedObjectModel *model = [[[NSManagedObjectModel alloc] initWithContentsOfURL:url] autorelease];
		
        NSString *dir = @"/var/jb/var/mobile/Library/Preferences/AutoAlerts/";
